...
namespace MonoGameParticles.Core.Localization;
...
internal class LocalizationManager
{
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        ResourceManager resourceManager = new ResourceManager("MonoGameParticles.Core.Localization.Resources", assembly);
