...
using MonoGameParticles.Core;

namespace MonoGameParticles.Android
{
    /// <summary>
    ...
    {
        private MonoGameParticlesGame _game;
        private View _view;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _game = new MonoGameParticlesGame();
